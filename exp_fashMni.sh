...
python main.py --dataset fashMni \
--gpu 1 --expNum 1 --useSepaUnit 1 --unsupLearn 2 \
--tcvae_flag 1 --alpha_z 0 --beta_z 96 --gamma_z 1 --alpha_y 0 --beta_y 2 --gamma_y 0 \
--indepLs_flag 1 --lamb_indep 4 \
--lamb_cls 40.8 --temperature 0.75 \
